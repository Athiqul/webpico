        ...
        <div class="max-w-[55rem] gap-5 relative  flex flex-col md:flex-row justify-between mx-auto mt-16 pb-20 border-b border-neutral mb-12">
            <div class="max-w-[14.63rem] ">
                ...
                <div class="pt-5 font-sans text-neutral space-y-3">
                    <p class="">House: 62, Dour Main Road, Block: D, Uttara Rajabari, Turag, Dhaka</p>
                    <p class="">hello[@]webpicodigital.com</p>
                    <p class="">+88 01752 598101</p>
                </div>
            </div>
            <div class="max-w-[14.63rem]">
            ...
            <img onclick="scrollToTop()" class="h-9 w-9 absolute right-3 -bottom-3 cursor-pointer" src="./assets/scroll-top.svg" alt="">
        </div>
